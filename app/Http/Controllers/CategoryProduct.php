...
class CategoryProduct extends Controller
{
   ...
   public function update_category_product(Request $request){
        ...
        $data['category_desc']=$request->category_product_desc;
        $data['category_status']=$request->category_product_status;
        DB::table('tbl_category_product')->where('category_id',$request->category_product_id)->update($data);
   ...
   public function Show_category_home($category_id){
    ...
    return view('pages.category.show_category')->with('all_brand',$all_brand_product)->with('all_category',$all_category_product)->with('category_by_id',$category_by_id)->with('category_name',$category_name);
   }
}
