...
return redirect::to('all-product');
   ...
   public function details_product($product_id){
    ...
    ->get();
      ...
      ->get();
          return view('pages.product.show_details')->with('related_product',$related_product)->with('all_brand',$all_brand_product)->with('all_category',$all_category_product)->with('details_product',$details_product);
   }  
}
